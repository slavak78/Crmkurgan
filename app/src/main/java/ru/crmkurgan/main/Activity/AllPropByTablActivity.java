...
public class AllPropByTablActivity extends AppCompatActivity {

    ArrayList<PropertyModels> listItem;
    public RecyclerView recyclerView;
    ListItem adapter;
    String valuemin, valuemax, sortdata, Id, value1min, value1max;
    private BottomSheetBehavior mBehavior;
    private BottomSheetDialog mBottomSheetDialog;
    ArrayList<String> tablNameList;
    ArrayList<TablModels> mListTabl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListTabl= new ArrayList<>();
        mListCat= new ArrayList<>();
        tablNameList= new ArrayList<>();
    ...
    private void sort() {
        ...
        radioGroupSort.setOnCheckedChangeListener((radioGroup, Check) -> {
            ...
            if (Check == R.id.sort_high) {
                save_sort=2;
                if (NetworkUtils.isConnected(AllPropByTablActivity.this)) {
                    JSONObject parameters = new JSONObject();
                    RequestQueue rq = Volley.newRequestQueue(AllPropByTablActivity.this);
    ...
    private void searchFilter() {
        ...
        ArrayAdapter<String> raionSpinner = new ArrayAdapter<>(AllPropByTablActivity.this, R.layout.spinner, raionNameList);
        ...
        submit.setOnClickListener(view -> {
            Intent intent = new Intent(AllPropByTablActivity.this, FilterSearchActivity.class);
    ...
    private void getData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Constants.BYTABL1+Id, parameters, response -> {
                    String respo=response.toString();
                    Log.d("responce",respo);
                    getDataAll(respo);
                    progress.setVisibility(View.GONE);
    ...
    private void getTabl() {
        ...
        RequestQueue rq = Volley.newRequestQueue(this);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Constants.BYTABLCAT + Id, parameters, response -> {
                    String respo=response.toString();
                    Log.d("responce",respo);
                    getDataTabl(respo);
                }, error -> Log.d("respo",error.toString()));
        ...
        try {
            ...
            if(code.equals("200")) {
                ...
                for (int i = 0; i < msg.length(); i++) {
                    ...
                    tablNameList.add(userdata.getString("cname"));
                    mListTabl.add(item);
                }
            }
        } catch (JSONException e) {
