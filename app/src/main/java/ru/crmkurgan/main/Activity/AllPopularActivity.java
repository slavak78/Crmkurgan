...
public class AllPopularActivity extends AppCompatActivity {
    ...
    private void searchFilter() {
        ...
        ArrayAdapter<String> raionSpinner = new ArrayAdapter<>(AllPopularActivity.this, R.layout.spinner, raionNameList);
    ...
    private void getData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Constants.ALLPOPULAR, parameters, response -> {
                    String respo=response.toString();
                    Log.d("responce",respo);
                    getDataAll(respo);
                    progress.setVisibility(View.GONE);
